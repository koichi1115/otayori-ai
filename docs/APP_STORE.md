...
### 2026-07-05 / v1.0 (build 45) — ✅ 審査通過・公開

- 3回目の提出で承認。対応履歴: Guideline 4（スクロール）→ScrollView化、
  4.8/2.1(a)（Google連携）→UI全撤去、5.1.1(iv)（カメラ許可）→OSダイアログ直行
- App Store URL: https://apps.apple.com/jp/app/id6782348124 （Apple ID: 6782348124）
- 公開サイト: https://purikan.app/
